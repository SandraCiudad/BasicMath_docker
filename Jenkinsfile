            ...
            steps {
                ...
                script {
                    dir("${env.WORKSPACE}") {
                        ...
                        // CCCC Code Analysis
                        sh '''cccc --html_outfile=index.html `find "./path/to/src" -name "*.cpp*" | grep -v ".svn" | grep -v ".cccc" | grep -v ".settings" | grep -v ".cproject"`; mv .cccc reports/cccc; mv index.html reports/cccc'''
